...
export async function fetchActivities(username) {
  ...
  const actionIcon = (name, alt) => `<a href="https://github.com/${username}" title="${alt}"><img alt="${alt}" src="https://github.com/${username}/${username}/raw/main/src/images/icons/${name}.png" align="top" height="18"></a>`;
  const serializers = {
